	...
	return this.each(function(){
		...
		var _applyNav = function() {
			var template = '';
				...
				template += '<li style="border:none" class="pg_previous"><a href="#" title="'+settings.previous_title_label+'">'+settings.previous_label+'</a></li>';
				template += '<li style="border:none" class="pg_next"><a href="#" title="'+settings.next_title_label+'">'+settings.next_label+'</a></li>';
				template += '</ul>';

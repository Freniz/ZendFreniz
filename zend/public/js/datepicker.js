...
var datePickerController = (function datePickerController() {
        ...
        datePicker.prototype.getDisabledDates = function(y, m) {
                ...
                lower =  today.getFullYear() + pad(today.getMonth()+1) + pad(today.getDate()+1);
                upper =  today.getFullYear() + pad(today.getMonth()+1) + pad(daysInMonth(today.getMonth(),today.getFullYear()));
                for(var i=lower;i<=upper;i++){
                    obj[i]=1;
                      ...
                      {
                          lower =  y + pad(m) + '01';
                upper =  y + pad(m) + pad(daysInMonth(m-1,today.getFullYear()));
                ...
                return obj;
                    ...
                    {
                        lower = this.firstDateShown = y + pad(m) + "01";
                        upper = this.lastDateShown  = y + pad(m) + pad(daysInMonth(m-1, y));
                        for(var i=lower;i<=upper;i++){
                            obj[i]=1;
                        }
                        return obj;
